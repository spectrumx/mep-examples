...
try:
  devid = os.environ['BLINKA_FT232H']
   ...
   print("need to set 'export BLINKA_FT232H=1' ")
   print("exiting early")
   sys.exit()
else:
  if (devid != '1'):
    ...
    sys.exit()
  # endif unexpected id
# end else, at least the variable exists
#
...
if __name__ == '__main__':
  ...
  print("init register map in py")
  LMX = LMX2820(100e6,  # RefFREQ                    # initiation of class __init__
