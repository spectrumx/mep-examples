...
ssh -i /home/mep/.ssh/id_rsa -t root@192.168.20.100 -o StrictHostKeyChecking=no -o GlobalKnownHostsFile=/dev/null "source /usr/local/share/pynq-venv/bin/activate && \
